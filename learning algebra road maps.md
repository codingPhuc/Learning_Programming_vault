# Table of Contents
- [Motivation and New Knowledge](#motivation-and-new-knowledge)
- [Transition from Algorithms to Reasoning](#transition-from-algorithms-to-reasoning)
- [Study Tips](#study-tips)
- [Key Considerations](#key-considerations)
- [Proof](#proof)
- [Practice](#practice)
- [Repetition in Learning](#repetition-in-learning)
- [Abstraction](#abstraction)
- [Rewriting and Symbol Creation](#rewriting-and-symbol-creation)
- [Refactoring Patterns](#refactoring-patterns)
- [Applying Spaced Repetition to Mathematics](#applying-spaced-repetition-to-mathematics)
...
## Transition from Algorithms to Reasoning
...
1. Study in the right environment.
    - Quiet. You need to be able to think deeply to learn Mathematics. A noisy environment creates obstacles to your concentration and creates distractions to focusing on the problems at hand.
...
2. Do your Math homework before homework in other subjects.
...
4. Study outside of class regularly.
...
5. Read your textbooks. See [reading Math textbooks](https://missioncollege.edu/depts/math/math-help/how-to-study-math/reading-textbooks.html) for details.
6. Get good at taking notes in class. See [note-taking](https://missioncollege.edu/depts/math/math-help/how-to-study-math/note-taking-for-college.html "taking notes") for more details.
7. Make summary sheets.
...
8. Practice all problems until you have mastered the ability to solve and check them.
9. Be aware of what topics you know well, which topics need more practice, and which topics you don't know at all.
10. Continually review: Review material from the beginning of the semester throughout the entire semester.
...
4. The proof should be separated into different sections of a course. For example, Algebra should have Preliminaries.
...
- At the community college level, introductory algebra courses often run for about 18 weeks. These courses may progress more rapidly than high school classes.
...
### Individual Strengths in Math Vary
...
### Transition to Advanced Math Takes Time
...
- Apps like Anki can help with retaining definitions and key theorems.
